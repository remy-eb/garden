...
export const pluginActionDescriptions: { [P in PluginActionName]: PluginActionDescription } = {
  getEnvironmentStatus: {
    description: dedent`
      ...
      If this returns \`needsUserInput: true\`, the process may throw an error and guide the user to
  ...
  cleanupEnvironment: {
    description: dedent`
      ...
      Like \`prepareEnvironment\`, this is called sequentially, so handlers are allowed to request user input
      if necessary.
